  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.Row}>
        <TouchableHighlight
          style={styles.Tile} onPress={() => handleTileClick(tile1, setSelected1)}>
        
          <Text style={styles.tileText}>{selected1 ? tile1 : ''}</Text>
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.Tile}  onPress={() => handleTileClick(tile2, setSelected2)}>
        
          <Text style={styles.tileText}>{selected2 ? tile2 : ''}</Text>
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.Tile}  onPress={() => handleTileClick(tile3, setSelected3)}>
      ...
      <View style={styles.Row}>
        <TouchableHighlight
          style={styles.Tile} onPress={() => handleTileClick(tile4, setSelected4)}>
        
          <Text style={styles.tileText}>{selected4 ? tile4 : ''}</Text>
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.Tile} onPress={() => handleTileClick(tile5, setSelected5)}>
        
          <Text style={styles.tileText}>{selected5 ? tile5 : ''}</Text>
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.Tile} onPress={() => handleTileClick(tile6, setSelected6)}>
